          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <div className="text-center lg:text-left order-2 lg:order-1">
              ...
              <div className="mb-6 slide-up">
                ...
                {/* Animated Role Text */}
                <div className="text-xl md:text-2xl lg:text-3xl text-gray-300 mb-6 h-12 flex items-center justify-center lg:justify-start">
                  <span className="mr-2">I'm a</span>
                  <span className="text-cyan-400 font-semibold min-w-[250px] text-left">
                    {displayText}
              ...
              {/* Description */}
              <p className="text-lg md:text-xl text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed slide-up" style={{animationDelay: '0.2s'}}>
              ...
              {/* CTA Buttons */}
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center mb-12 slide-up" style={{animationDelay: '0.4s'}}>
                <a
                  href="resume.pdf"
                  download
            ...
            {/* Profile Image */}
            <div className="order-1 lg:order-2 flex justify-center lg:justify-end slide-up">
